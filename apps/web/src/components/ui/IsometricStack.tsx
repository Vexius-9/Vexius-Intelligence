        ...
        {layers.map((layer, idx) => (
          ...
          >
            ...
            <div style={{
              ...
              alignItems: "center",
              justifyContent: "center",
              border: layer.isTop ? "1.5px solid #52525b" : "1.5px solid #3f3f46",
              backgroundColor: layer.isTop ? "#18181b" : "#09090b",
            ...
            <div style={{
              ...
              overflow: "hidden",
              border: layer.isTop ? "1.5px solid #52525b" : "1.5px solid #3f3f46",
              backgroundColor: layer.isTop ? "#27272a" : "#18181b",
              transformOrigin: "top",
            ...
            <div style={{
              ...
              overflow: "hidden",
              border: layer.isTop ? "1.5px solid #52525b" : "1.5px solid #3f3f46",
              backgroundColor: layer.isTop ? "#3f3f46" : "#27272a",
